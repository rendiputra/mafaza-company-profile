                ...
                <table class="table table-hover">
                  ...
                  <tbody>
                    ...
                    while ($d = mysqli_fetch_array($result)) {
                      ...
                      echo '<td> <a href="/admin?page=update-artikel&update_id=' . $d['id_artikel'] . '" class="btn btn-info mr-1 mt-1">Update</a><a href="../core/delete_artikel_act.php?page=delete-artikel&delete_id=' . $d['id_artikel'] . '" class="btn btn-danger">Delete</a> </td>';
                      echo '</tr>';
                    }
                    ?>
                  </tbody>
